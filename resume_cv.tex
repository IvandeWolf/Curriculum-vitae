...
\name{Ivan}{de Wolf}
\address{Dennenlaan 73BIS, 3904 KM, Veenendaal, The Netherlands}
\mobile{0622419027}

\email{ivan.dewolf1997@gmail.com}
\homepage{ivandewolf.nl}
\github{IvandeWolf}
\linkedin{IvandeWolf}
%\skype{skypeid}
...
\position{Software Development} % Your expertise/fields ({\enskip\cdotp\enskip})
\quote{``All our dreams can come true, if we have the courage to pursue them. - Walt Disney"} % A quote or statement

\makecvfooter{\today}{Ivan de Wolf~~~·~~~CV}{} %{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
